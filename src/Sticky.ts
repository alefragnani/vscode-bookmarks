...
export class Sticky {
    ...
    public static stickyBookmarks(event: vscode.TextDocumentChangeEvent, 
            activeEditorCountLine: number, activeBookmark: BookmarkedFile, 
            activeEditor: vscode.TextEditor, controller: BookmarksController): boolean {
    ...
    public static moveStickyBookmarks(direction: string, activeBookmark: BookmarkedFile, activeEditor: vscode.TextEditor, controller: BookmarksController): boolean {
